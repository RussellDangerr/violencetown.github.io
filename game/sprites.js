...
//
// Nothing reads this table yet — zone-identity.md Item 3 wires the
// gravestones up as props and the circus tents in as a set piece; Item 1
// wires the floor pair in as interior ground. Don't delete this as "unused."
export const OUTLINED_SPRITES = {
    // Gravestones — 12 distinct silhouettes, meant to replace the single
    // reused tinyDungeon (4,5) cross that currently covers all 96 grave cells.
